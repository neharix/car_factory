...
class Car(models.Model):
    ...
    characteristics_docx = models.FileField(upload_to='car/characteristics/docx/', null=True, blank=True)
    characteristics_pdf = models.FileField(upload_to='car/characteristics/pdf/', null=True, blank=True)
